...
<head>
  ...
  <style>
    body {
      ...
      min-height: 100vh;
      background-image: url('/../src/image/fond.jpg'); /* Remplacez 'url_de_votre_image.jpg' par le chemin de votre image */
      background-size: cover; /* Assurez-vous que l'image de fond couvre toute la surface du body */
      ...
      {% if session.admin  %}
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <!-- Si l'utilisateur est connecté, affiche le lien de déconnexion -->
              ...
              <li class="nav-item">
                <a class="nav-link" href="/Update">Liste des Commandes</a>
            </li>
          </ul>
        </div>
              
      {% elseif not session.admin and session.estconnecter %}
          <div class="collapse navbar-collapse" id="navbarResponsive">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="/Accueil">Accueil</a>
